...
if(isset($_POST['submit']))
{
    ...
    if($result)
    {
        ...
        header('location:../admin_reservation/admin_pending.php');
...
?>
    <button class="back_button" name="back"><a href="../admin_reservation/admin_pending.php" class="a2">BACK</a></button> <br>
<?php 
