...
?>
                    ...
                    <button class="button_selected" name="pending_reservations"><a href="admin_pending.php" class="a2">PENDING RESERVATIONS</a></button>
                    ...
                    <div class="table_display">
                            <table>
                                ...
                                <tbody>
                            <?php 
                            $sql="Select * from `user_reserveform` where admin_status='For approval'";
                            ...
                            if($result){
                                while($row=mysqli_fetch_assoc($result))
                                {
                                    ...
                                    echo'<tr>
                                            ...
                                            <button class="table_button" name="view"><a href="../admin_process_pending/view.php?viewreservation_id='.$reservation_id.'">VIEW</a></button>
                                            <button class="table_button" name="update"><a href="../admin_process_pending/update.php?updatereservation_id='.$reservation_id.'">UPDATE</a></button>
                                            <button class="table_button" name="delete"><a href="../admin_process_pending/delete.php?deletereservation_id='.$reservation_id.'" class="a2">DELETE</a></button>
                                                </td>
                                        <tr>
                                    ';
                                }
