...
/* These codes are to locate the new created form in which user account
currently used */

if(isset($_SESSION['username'])) {
    $user = $_SESSION['username'];

    $query = ("Select * from `useraccount` WHERE username = '$user'");
...
if(isset($_POST['submit']))
{
    ...
    if(empty($name) || empty($contact_number)|| empty($time_begins)|| empty($email) || empty($date)|| empty($time_ends)) 
    {
        header("Location: form.php?error=1");
    } 
    else    
    {
    // Adding user_id column and set it to the id in useraccount 
    $sql="insert into `user_reserveform` (reservation_id, user_id, name,contact_number,time_begins,email,date,time_ends,
    book1,book2,book3,book4,beverage1,pastry1,beverage2,pastry2,admin_status,admin_note)
    values(NULL,'$id', '$name','$contact_number','$time_begins','$email','$date','$time_ends',
    '$book1','$book2','$book3','$book4','$beverage1','$pastry1','$beverage2','$pastry2','$admin_status','$admin_note')";
            ...
            <div class="row">
                ...
                <div class="left">
                    ...
                    <div class="form_container">
                        <h1 class="label"> RESERVATION FORM</h1>
                        <?php
                        if($_GET["error"]==1) 
                        {
                            echo '<p style="color: red; font-size: 15px; text-align: center;">All fields are required.</p>';
                        } 
                        ?>
                        ...
                        <form method="post" action="">
                            <h2>BASIC INFORMATION</h2>
                                <div class="form_left">
                                    ...
                                    <input type="text" class="form-control"  name="contact_number"><br> 
                                ...
                                <div class="form_right">
                                    ...
                                    <input type="email" class="form-control"  placeholder="@gmail.com" name="email"><br> 
                        ...
                        <div class="status_form" hidden>
                            <h2>STATUS</h2>
                                    <p class="note" >Dear Customer, only the admin can edit your reservation status. Thank you!</p>
                                    <div class="form_left">
                                    <label class="form-label" hidden>Status</label> <br> 
                                    ...
                                    <div class="form_right">
                                        ...
                                        <input type="text" class="form-control" name="admin_note" ><br> 
                                    </div>
                        </div> <br> 
                        <p class="note" >To our valued customer, after submitting this reservation, wait for the Cafe Librew to confirm your reservation. Thank you!</p>
                        
                        <button class="submit_button" name="submit">SUBMIT</button> <br>
                        </form>

                        <button class="back_button" name="back"><a href="account.php" class="a2">BACK</a></button> <br>
                        <div> 
                        </div> 
                    </div>
                </div>
