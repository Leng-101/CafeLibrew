                    ...
                    <div class="form_container">
                        ...
                        <div class="status_form" hidden>
                            <h2>STATUS</h2>
                                    ...
                                    <div class="form_right">
                                        <label for="admin_note" class="form-label">Cafe Librew' Message</label><br> 
                                        <input type="text" class="form-control" name="admin_note" ><br> 
                                    </div>
                        </div> <br> 
                        <p class="note" >Dear Customer, after updating this reservation, wait for the Cafe Librew to confirm your reservation. <br> Once this reservation is confirmed you cannot change anything. Thank you!</p>
                        
                        <button  class="submit_button" name="submit">UPDATE</button> <br>
                        </form>

                        <button class="back_button" name="back"><a href="../user_webpage/account.php" class="a2">BACK</a></button> <br>
                        <div> 
                        </div> 
                    </div>
                </div>
