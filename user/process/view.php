                        ...
                        <div class="status_form" >
                            <h2>STATUS</h2>
                                <div class="form_left">
                                    ...
                                    <input type="text" class="form-control" name="admin_status" value="<?php echo $admin_status;?>"disabled><br> 
                                </div>
                                <div class="form_right">
                                        <label for="admin_note" class="form-label">Cafe Librew's Message</label><br> 
